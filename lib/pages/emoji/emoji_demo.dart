...
class EmojiDemoPage extends StatefulWidget {
  const EmojiDemoPage({Key? key}) : super(key: key);

  @override
  State<EmojiDemoPage> createState() => _EmojiDemoPageState();
}

class _EmojiDemoPageState extends State<EmojiDemoPage> {
  List<Map<String, String>> regionCodes = [
    {
      "name": "Afghanistan",
      "dialCode": "+93",
      "isoCode": "AF",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('EmojiDemoPage'),
      ),
  ...
  Widget itemBuilder(BuildContext context, int index) {
    Map item = regionCodes[index];
    return Center(
      child: Text(
        '${EmojiConverter.fromAlpha2CountryCode(item['isoCode'])} ${item['isoCode']}',
